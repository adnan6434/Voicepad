...
namespace Voice_Pad
{
    public partial class Form1 : Form
    {
        ...
        #region Main text to speech funtionality 
        ...
        #region rich textbox context menu
        ...
        #region voice speed and volume control
        ...
        #region menustrip 2nd part, file create save and etc funtionality done 
        ...
        {
            //DialogResult dr = MessageBox.Show("VoicePad\nDeveloped By: Adnan Taufique and Farhana Moury  \n©All Rights Reserved 2016 ", "About ", MessageBoxButtons.OK, MessageBoxIcon.Information);
            AboutBox1 box = new AboutBox1();
            box.ShowDialog();
        }

        //format toolstrip button er function, Everything is built in , so we just called these 
